            ...
            <div className="container">
                <div className="content !gap-20">
                    ...
                    <form className="flex flex-col !gap-10 !w-full items-center justify-center" onSubmit={handleSubmit}>
                        <input value={data.title} required onChange={(e) => setData({ ...data, title: e.target.value })} placeholder="Title" type="text" className="w-full bg-secdanry !px-5 !py-4 rounded-2xl text-xl border-none outline-none hover:scale-103 transform transition-all duration-300" />
